...
# flip order of levels so we get present as an effect
levels(jitter_obs$wbc) = c("absent","present")

a5ssn_wswq_ml1 <- ssn_lm(
  formula = vsci ~ pct_imp_w_emplog + elev_ws + do + vahusb_JL + wbc+  wbc:dist_nearest_up_wb_km - dist_nearest_up_wb_km,
  ssn.object = jit_ssn,
  tailup_type = "none",
  taildown_type = "exponential",
  euclid_type = "exponential",
